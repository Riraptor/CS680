...
public class FIFOTempleteTest {
	...
	public void FIFOFetchFourFiles() throws ClassNotFoundException, IOException {
		FIFOFileCache lala = FIFOFileCache.getInstance();
		Path CachePathA = FileSystems.getDefault().getPath("src","homework18","file_root","a.html");
		Path CachePathB = FileSystems.getDefault().getPath("src","homework18","file_root","b.txt");
		Path CachePathC = FileSystems.getDefault().getPath("src","homework18","file_root","c.txt");
		Path CachePathD = FileSystems.getDefault().getPath("src","homework18","file_root","d.txt");
		...
		String actual4 = "REPLACED BY d.txt";
